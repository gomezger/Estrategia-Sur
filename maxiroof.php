...
<head>
    ...
    <title>Maxiroof | Fachadas y Muros | Estrategia Sur | Paneles Aislantes | Bahía Blanca</title>
...
<body>
    ...
    <section class="pl-0 pr-0 portada col-12 float-left">
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            <div class="imagen">
                <img src="img/techos-cubiertas/maxiroof/teja.png"/>
            </div>
            <div class="texto">
                La solución aislante para techos y cubiertas. Panel en núcleo de poliuretano de alta 
                densidad con doble recubrimiento en acero galvanizado. Una propuesta integral a la 
                altura de las grandes exigencias de la construcción.
            </div>
        </div>
    </section>
    <!-- PORTADA End -->
    ...
    <section class="caracteristicas col-12">
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            ...
            <div class="row mb-5">
                <div class="col-12 col-md-6 d-inline-block">
                    <img class="mt-0 mt-md-5" src="img/techos-cubiertas/maxiroof/esp-tec-1.jpg" />
                </div>
                <div class="col-12 col-md-6 d-inline-block text-center">
                    <img src="img/techos-cubiertas/maxiroof/esp-tec-2.jpg" />
                    <p class="mt-3 text-justify text-dark">
                        Panel metálico con núcleo aislante de polluretano de alta densidad, inyectado 
                        en línea contínua. Utilizable en cubiertas y restimientos de muros de todo 
                        tipo de edificaciones.
                    </p>
                    <img src="img/techos-cubiertas/maxiroof/esp-tec-3.jpg" />
                </div>
            </div>
        </div>    
        <div class="col-12 p-0 row detalles text-right ">
            <div class="imagen col-12 col-md-6 d-none d-md-inline-block">
                <img class="mt-0" src="img/techos-cubiertas/maxiroof/esp-tec-4.jpg" />
            </div>            
            <div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
                <div class="col-12 col-md-6 d-inline-block text-left pt-1 pl-3 pr-3 pr-md-0 pl-md-5 info ">
                    <h6 class="mb-2">Cara exterior:</h6>
                    <ul class="ml-4 mb-4">
                        <li><strong>Material:</strong> Acero galvanizado prepintado blanco o cincalum. </li>
                        <li><strong>Colores:</strong> Colores especiales consultar en fábrica. </li>
                        <li><strong>Conformado exterior:</strong> Trapezoidal 5 crestas.</li>
                        <li><strong>Conformado interior:</strong> Tableteado.</li>
                    ...
                    <ul class="ml-4 mb-5">
                        ...
                        <li><strong>Espesor nominal:</strong> 30, 50 y 80mm.</li>
                        <li><strong>Largos:</strong> Máximo hasta 14 mt., otros largos consultar. Longitud mínima 2,5 mts. 1000 mm.</li>   
                    </ul>
                </div>
            </div>
        </div>        
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            ...
            <div class="info text-center">
                <img class="d-inline-block" src="img/techos-cubiertas/maxiroof/esp-tec-5.jpg" />
                <p class="texto-tablas col-12 col-sm-10 col-xl-9 d-inline-block mt-5 text-justify p-0 text-dark">
                    Las luces L en metros correspondientes a las sobrecargas P (kg/m2) 
                    uniformemente distribuídas, han sido obtenidas por pruebas de carga 
                    efectuadas en nuetros laboratorios y garantizan simultáneamente una 
                    flecha F < L/200 considerando como sección resistente solo la chapa
                     (no se ha considerado la portación del poliuretano) de conformidad 
		...
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 container">
            ...
            <div class="col-12 p-0 text-center mb-4">
                <img class="d-inline-block col-12 col-md-6 m-0 p-0 float-left" src="img/techos-cubiertas/maxiroof/de-img-1-ok.jpg" />
                <img class="d-inline-block col-12 col-md-6 m-0 p-0 float-left" src="img/techos-cubiertas/maxiroof/img-1-ok-2.jpg" />
            </div>
        </div>
