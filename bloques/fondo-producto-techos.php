<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 container">
    ...
    <div class="row mb-5">
        ...
        <div class="col-12 col-md-6 d-inline-block text-center">
            <p class="accesorios mt-3 p-3 p-md-5 text-left">
                › <strong>Uso en obras</strong> nuevas o remodelaciones.<br>
                › <strong>Múltiples posibilidades</strong> de terminaciones.<br>
                › <strong>Calidad autoportante</strong>, liviano y fácil de instalar.<br>
                › <strong>Alta versatilidad</strong>, aplicaciones en fachadas, cubiertas, cielorrasos, divisiones interiores, etc.<br>
                › <strong>Estabilidad</strong> térmica y acústica.<br>
            </p>
        </div>
    </div>
</div>
...
<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 container">
    ...
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Perfil metálico goteo.</li>
        </ul>
    </div>
    <!-- bloque 1 fin -->
    <!-- bloque 2 -->
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Capeloto.</li>                 
            <li class="list-group-item p-1"><span>E.</span> Estructura soporte de cubierta.</li>                 
            <li class="list-group-item p-1"><span>F.</span> Perfil metálico bajocumbrera.</li>
        </ul>
    </div>
    <!-- bloque 2 fin -->
    <!-- bloque 3 -->
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Muro de construccion tradicional.</li>                 
            <li class="list-group-item p-1"><span>E.</span> Muro de construccion tradicional.</li>  
        </ul>
    </div>
    <!-- bloque 3 fin -->
    ...
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Aislación térmica en panel.</li>                  
            <li class="list-group-item p-1"><span>E.</span> Perfil metálico de terminación.</li>
        </ul>
    </div>
    <!-- bloque 4 fin -->
    <!-- bloque 5 -->
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Muro de construcción tradicional.</li>                 
            <li class="list-group-item p-1"><span>E.</span> Remaches POP. Colocación panel.</li>                 
            <li class="list-group-item p-1"><span>F.</span> Instalaciones ocultas entre panel y placa de yeso interior.</li>             
            <li class="list-group-item p-1"><span>F.</span> Placa de yeso interior.</li>
        </ul>
    </div>
    <!-- bloque 5 fin -->
    <!-- bloque 6 -->
    <div class="bloque col-12 col-sm-6 col-md-4">
        ...
        <ul class="lista col-12 list-group p-0 pt-2">
            ...
            <li class="list-group-item p-1"><span>D.</span> Panel de cubierta aislante.</li>                 
            <li class="list-group-item p-1"><span>E.</span> Perfil metálico de terminación.</li>  
        </ul>
    </div>
    <!-- bloque 6 fin -->
