...
<head>
    ...
    <title>Foilroof Trapezoidal | Fachadas y Muros | Estrategia Sur | Paneles Aislantes | Bahía Blanca</title>
...
<body>
    ...
    <section class="pl-0 pr-0 portada col-12 float-left">
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            <div class="imagen">
                <img src="img/techos-cubiertas/foilroof-t/Sin-título-1.png"/>
            </div>
            <div class="texto">
                Excelente solución aislante para techos y cubiertas. Panel en núcleo de alta densidad 
                con recubrimiento en acero galvanizado en cara superior y foil en cara inferior. Una 
                propuesta práctica y accesible que marca la nueva tendencia en la construcción.
            </div>
        </div>
    </section>
    <!-- PORTADA End -->
    ...
    <section class="caracteristicas col-12">
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            ...
            <div class="row mb-5">
                <div class="col-12 col-md-6 d-inline-block">
                    <img class="mt-0 mt-md-5" src="img/techos-cubiertas/foilroof-t/esp-tec-1.jpg" />
                </div>
                <div class="col-12 col-md-6 d-inline-block text-center">
                    <img src="img/techos-cubiertas/foilroof-t/esp-tec-2.jpg" />
                    <p class="mt-3 text-justify text-dark">
                        Panel de acero fabricado en proceso de línea contínua, con núcleo aislante de poliuretano 
                        inyectado de alta densidad. Cara exterior en chapa galvanizada prepintada y cara 
                        interior en foil de polipropileno.
                    </p>
                    <img src="img/techos-cubiertas/foilroof-t/esp-tec-3.jpg" />
                </div>
            </div>
        </div>    
        <div class="col-12 p-0 row detalles text-right ">
            <div class="imagen col-12 col-md-6 d-none d-md-inline-block">
                <img class="mt-0" src="img/techos-cubiertas/foilroof-t/esp-tec-4.jpg" />
            </div>            
            <div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
                <div class="col-12 col-md-6 d-inline-block text-left pt-1 pl-3 pr-3 pr-md-0 pl-md-5 info ">
                    <h6 class="mb-2">Cara exterior:</h6>
                    <ul class="ml-4 mb-4">
                        <li><strong>Material:</strong> Acero galvanizado prepintado blanco o cicalum. </li>
                        <li><strong>Colores:</strong> Colores especiales consultar en fábrica. </li>
                        <li><strong>Acabado de la chapa:</strong> Trapezoidal 5 crestas.</li>
                    ...
                    <ul class="ml-4 mb-5">
                        ...
                        <li><strong>Largos:</strong> Máximo hasta 14mt., otros largos consultar. Longitud mínima 2,5 mts.</li>   
                    </ul>
                </div>
            </div>
        </div>        
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 pl-md-2 pr-md-2 container">
            ...
            <div class="info text-center">
                <img class="d-inline-block" src="img/techos-cubiertas/foilroof-t/esp-tec-5.jpg" />
		...
		<div class="mx-auto col-12 col-sm-10 col-xl-9 p-0 m-0 container">
            ...
            <div class="col-12 p-0 text-center mb-4">
                <img class="d-inline-block col-12 col-md-6 m-0 p-0 float-left" src="img/techos-cubiertas/foilroof-t/img-foilrooftrape-1-ok-1.jpg" />
                <img class="d-inline-block col-12 col-md-6 m-0 p-0 float-left" src="img/techos-cubiertas/foilroof-t/img-2-ok.jpg" />
            </div>
        </div>
